...
//total graph data
    ...
    //male per month
$sql_sept_male ="SELECT count(id) As total_sept_male FROM reports WHERE gender='MALE' AND MONTH(alarm_issue_date) BETWEEN 1 AND 3 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_oct_male ="SELECT count(id) As total_oct_male FROM reports WHERE gender='MALE' AND MONTH(alarm_issue_date) BETWEEN 4 AND 6 AND status=3 OR status=4 OR status=5 - 1";
    $result_oct_male=mysqli_query($mysqli,$sql_oct_male);
    $values=mysqli_fetch_assoc($result_oct_male);
    $male_oct=$values['total_oct_male'];
$sql_nov_male ="SELECT count(id) As total_nov_male FROM reports WHERE gender='MALE' AND MONTH(alarm_issue_date) BETWEEN 7 AND 9 AND status=3 OR status=4 OR status=5 - 1";
    $result_nov_male=mysqli_query($mysqli,$sql_nov_male);
    $values=mysqli_fetch_assoc($result_nov_male);
    $male_nov=$values['total_nov_male'];
$sql_dec_male ="SELECT count(id) As total_dec_male FROM reports WHERE gender='MALE' AND MONTH(alarm_issue_date) BETWEEN 10 AND 12 AND status=3 OR status=4 OR status=5 - 1";
    $result_dec_male=mysqli_query($mysqli,$sql_dec_male);
    $values=mysqli_fetch_assoc($result_dec_male);
    $male_dec=$values['total_dec_male'];

    //female per month
$sql_sept_female ="SELECT count(id) As total_sept_female FROM reports WHERE gender='FEMALE' AND MONTH(alarm_issue_date) BETWEEN 1 AND 3 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_oct_female ="SELECT count(id) As total_oct_female FROM reports WHERE gender='FEMALE' AND MONTH(alarm_issue_date) BETWEEN 4 AND 6 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_nov_female ="SELECT count(id) As total_nov_female FROM reports WHERE gender='FEMALE' AND MONTH(alarm_issue_date) BETWEEN 7 AND 9 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_dec_female ="SELECT count(id) As total_dec_female FROM reports WHERE gender='FEMALE' AND MONTH(alarm_issue_date) BETWEEN 10 AND 12 AND status=3 OR status=4 OR status=5 - 1";
    ...
    //children (0-17 y/old) 
$sql_sept_children ="SELECT count(id) As total_sept_children FROM reports WHERE age BETWEEN 0 AND 17 AND MONTH(alarm_issue_date) BETWEEN 1 AND 3 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_oct_children ="SELECT count(id) As total_oct_children FROM reports WHERE age BETWEEN 0 AND 17 AND MONTH(alarm_issue_date) BETWEEN 4 AND 6 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_nov_children ="SELECT count(id) As total_nov_children FROM reports WHERE age BETWEEN 0 AND 17 AND MONTH(alarm_issue_date) BETWEEN 7 AND 9 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_dec_children ="SELECT count(id) As total_dec_children FROM reports WHERE age BETWEEN 0 AND 17 AND MONTH(alarm_issue_date) BETWEEN 10 AND 12 AND status=3 OR status=4 OR status=5 - 1";
    ...
    //adult (18-59 y/old)
$sql_sept_adult ="SELECT count(id) As total_sept_adult FROM reports WHERE age BETWEEN 18 AND 59 AND MONTH(alarm_issue_date) BETWEEN 1 AND 3 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_oct_adult ="SELECT count(id) As total_oct_adult FROM reports WHERE age BETWEEN 18 AND 59 AND MONTH(alarm_issue_date) BETWEEN 4 AND 6 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_nov_adult ="SELECT count(id) As total_nov_adult FROM reports WHERE age BETWEEN 18 AND 59 AND MONTH(alarm_issue_date) BETWEEN 7 AND 9 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_dec_adult ="SELECT count(id) As total_dec_adult FROM reports WHERE age BETWEEN 18 AND 59 AND MONTH(alarm_issue_date) BETWEEN 10 AND 12 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_sept_senior ="SELECT count(id) As total_sept_senior FROM reports WHERE age BETWEEN 60 AND 200 AND MONTH(alarm_issue_date) BETWEEN 1 AND 3 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_oct_senior ="SELECT count(id) As total_oct_senior FROM reports WHERE age BETWEEN 60 AND 200 AND MONTH(alarm_issue_date) BETWEEN 4 AND 6 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_nov_senior ="SELECT count(id) As total_nov_senior FROM reports WHERE age BETWEEN 60 AND 200 AND MONTH(alarm_issue_date) BETWEEN 7 AND 9 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_dec_senior ="SELECT count(id) As total_dec_senior FROM reports WHERE age BETWEEN 60 AND 200 AND MONTH(alarm_issue_date) BETWEEN 10 AND 12 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_sept_report ="SELECT count(id) As total_sept_report FROM reports WHERE MONTH(alarm_issue_date) BETWEEN 1 AND 3 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_oct_report ="SELECT count(id) As total_oct_report FROM reports WHERE MONTH(alarm_issue_date) BETWEEN 4 AND 6 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_nov_report ="SELECT count(id) As total_nov_report FROM reports WHERE MONTH(alarm_issue_date) BETWEEN 7 AND 9 AND status=3 OR status=4 OR status=5 - 1";
...
$sql_dec_report ="SELECT count(id) As total_dec_report FROM reports WHERE MONTH(alarm_issue_date) BETWEEN 10 AND 12 AND status=3 OR status=4 OR status=5 - 1";
